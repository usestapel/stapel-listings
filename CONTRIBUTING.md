# Contributing to stapel-listings
...
```bash
git clone https://github.com/usestapel/stapel-listings.git && cd stapel-listings
...
- **No new hardcoded behavior.** Anything a host project might want to
  ...
  (`STAPEL_LISTINGS` dict; see `conf.py`) — with a dotted-path
